          ...
          <div className={style.div}>
            {loading && (
              <>
                ...
                <p>
                  <b>Tempo de preparo:</b> {receita.tempo} min
                </p>
                <p>
                  <b>Rende:</b> {receita.porcoes} porções
                </p>
                <p>
                  <b>Likes:</b> {receita.favoritos}
                </p>
              </>
            )}
          </div>
