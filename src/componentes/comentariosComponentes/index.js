...
function ComentariosComponente({idreceita, setComentarios, comentariosarray, reload, setReload}) {
             ...
             return (<div className={style.container} key={element._id}>
              <div style={{display:"flex"}}> 
                   <div  >
                    ...
                    <p ><b> Nota: {element.avaliacao}</b></p>
                   </div>
  ...
  {editar&&
                <ComentariosEditar idcomentario={element._id} element={element} reload={reload} setReload={setReload} editar={editar} setEditar={setEditar}/>}
              </div>)
